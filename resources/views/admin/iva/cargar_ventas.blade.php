...
<div class="container">
	 <div class="row justify-content-center">
        <div class="col-md-12">
        		{{ Breadcrumbs::render('admin_iva_ventas_cargar') }}
        </div>
    </div>
       <div class="row justify-content-center">
        <div class="col-md-12">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header"><h4><i class="fa fa-plus"> </i> Cargar Ventas para <b> <i class="fa fa-user"> </i> {!!$cliente[0]->NRODOC !!} | {!!$cliente[0]->CONTRIBUYENTE !!}</b> </h4> 
                </div>
                <div class="card-body">
                     {!! BootForm::open()->action(route('admin.iva.ventas.guardar')) !!}
