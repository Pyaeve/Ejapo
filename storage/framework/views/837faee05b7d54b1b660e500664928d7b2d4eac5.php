...
<div class="container">
     <div class="row justify-content-center">
        <div class="col-md-12">
                <?php echo e(Breadcrumbs::render('admin_iva_ventas_clientes')); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4><i class="fa fa-check"></i> Selecione un cliente</h4></div>
                    ...
                    <table class="table table-striped table-hover table-condensed table-responsive">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($node->REGIMEN=='IVA'): ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo route('admin.iva.compras.cargar',['id'=>$node->ID]); ?>" class="btn btn-primary  "><i class="fa fa-check"> </i> Seleccionar&nbsp;</a>
