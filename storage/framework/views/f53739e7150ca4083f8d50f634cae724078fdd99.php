            ...
            <div class="card">
                ...
                <div class="card-body ">
                   <div class="container">    
                        ...
                        <li class='nav-item'><a href="#ct" class="nav-link active" role="tab" data-toggle="tab">Clientes</a></li>
                        <li class='nav-item'><a href="#cf" class="nav-link" role="tab" data-toggle="tab">No Clientes</a></li>
                    ...
                    <table class="table table-striped table-hover table-condensed table-responsive">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo route('admin.contribuyentes.editar',['id'=>$node->ID]); ?>" class="btn btn-sm btn-primary  "><i class="fa fa-pencil"> </i> Editar</a>
                                        
                                        <a href="#"  data-id="<?php echo $node->ID; ?>" class="btn-action-drop btn btn-sm btn-primary  "><i class="fa fa-trash"> </i> Borrar</a>
                                            <?php if($node->CLIENTE=='Si'): ?>
                                             
                                               <?php if($node->REGIMEN=='IRP'): ?>
                                                <a href="<?php echo route('admin.familiares.ver',['id'=>$node->ID]); ?>" class="btn btn-sm btn-primary "><i class="fa fa-eye"></i> Ver Familiares</a>
                                                <a class="btn btn-primary" href="<?php echo route('admin.irp.ingresos.cargar',['id'=>$node->ID]); ?>"><i class="fa fa-plus"></i> Cargar Ingresos</a> 
                                                <a class="btn btn-primary" href="<?php echo route('admin.irp.egresos.cargar',['id'=>$node->ID]); ?>"><i class="fa fa-plus"></i> Cargar Egresos</a>
                                                <a class="btn btn-primary" href="<?php echo route('admin.contribuyentes.balance',['id'=>$node->ID,'p'=>'2020']); ?>"><i class="fa fa-eye"></i> Ver Balance IRP</a>  
                                             <?php elseif($node->REGIMEN=='IVA'): ?>
                                                <a class="btn btn-primary" href="<?php echo route('admin.iva.ventas.cargar',['id'=>$node->ID]); ?>"><i class="fa fa-plus"></i> Cargar Ventas</a> 
                                                <a class="btn btn-primary" href="<?php echo route('admin.iva.compras.cargar',['id'=>$node->ID]); ?>"><i class="fa fa-plus"></i> Cargar Compras</a>
                                            <?php endif; ?>
                    ...
                    <table class="table table-striped table-hover table-condensed table-responsive">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo route('admin.contribuyentes.editar',['id'=>$node->ID]); ?>" class="btn btn-primary  "><i class="fa fa-pencil"></i> Editar&nbsp;</a>
                                         <a href="<?php echo route('admin.contribuyentes.borrar',['id'=>$node->ID]); ?>" class="btn btn-primary" data-toggle="modal" data-target="#modal-confirm-drop"><i class="fa fa-trash"></i> Borrar;</a>
                                            <?php if($node->CLIENTE=='Si' ): ?>
