...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header"><h4><i class="fa fa-plus">  </i> Cargar Compras para <b><i class="fa fa-user">  </i> <?php echo $cliente[0]->NRODOC; ?> | <?php echo $cliente[0]->CONTRIBUYENTE; ?></b>  </h4> 
                </div>
                <div class="card-body">
                     <?php echo BootForm::open()->action(route('admin.iva.compras.guardar')); ?>
