...
<div class="container">
     <div class="row justify-content-center">
        <div class="col-md-12">
                <?php echo e(Breadcrumbs::render('admin_irp_ingresos_clientes')); ?>
                    ...
                    <table class="table table-striped table-hover table-condensed table-responsive">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo route('admin.irp.ingresos.cargar',['id'=>$node->ID]); ?>" class="btn btn-primary  ">Seleccionar</a>          
                                    </td>
                                    <td>
                                        <?php echo $node->ID; ?>
