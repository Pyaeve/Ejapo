...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><i class="fa fa-check"></i> Selecione un cliente</div>
                    ...
                    <table class="table table-striped table-hover table-condensed table-responsive">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo route('admin.iva.ventas.cargar',['id'=>$node->ID]); ?>" class="btn btn-primary  "><i class="fa fa-check"> Seleccionar&nbsp;</a>
